(function() {
  var clean_result, code, console, cycle, format_result, jsdom, path, run, sandbox, stdin, util, vm;
  util = require('util');
  vm = require('vm');
  jsdom = require('jsdom');
  path = require('path');
  ...
  run = function() {
    ...
    try {
      return jsdom.env(html, ["http://ajax.googleapis.com/ajax/libs/jquery/" + context.version + "/jquery.min.js"], function(errors, window) {
        var result;
        try {
